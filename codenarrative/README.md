<p align="center">
  <img src="docs/logo.png" alt="CodeNarrative Logo" width="200" />
</p>
...
<p align="center">
  ...
  <a href="backend/"><img src="https://img.shields.io/badge/Backend-AWS%20SAM-orange" alt="AWS SAM" /></a>
  <a href="frontend/"><img src="https://img.shields.io/badge/Frontend-React%20%2B%20Tailwind-61DAFB" alt="React" /></a>
...
> 📖 **First time with AWS?** See **[docs/AWS-SETUP.md](docs/AWS-SETUP.md)** for step-by-step instructions.
...
| Guide | Description |
|-------|-------------|
| [Architecture & Flow](docs/ARCHITECTURE-AND-FLOW.md) | System architecture and data flow |
| [AWS Setup](docs/AWS-SETUP.md) | Step-by-step AWS/Bedrock setup |
| [Full Setup Checklist](docs/FULL-SETUP-CHECKLIST.md) | Complete deployment checklist |
| [Start & Test](docs/START-AND-TEST.md) | How to run and test locally |
| [Technical Documentation](docs/technical-documentation.md) | In-depth technical reference |
| [Judge Demo Checklist](docs/JUDGE-DEMO.md) | Quick demo walkthrough |
...
<p align="center">
  <img src="docs/logo.png" alt="CodeNarrative" width="60" />
  <br />
