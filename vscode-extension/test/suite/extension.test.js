...
suite('Extension basic activation', () => {
    test('Extension activates and registers commands', async () => {
        ...
        assert.ok(explain.includes('codeNarrative.explainSelection'), 'Explain selection command should be registered');
        assert.ok(explain.includes('codeNarrative.office.open'), 'Office open command should be registered');
